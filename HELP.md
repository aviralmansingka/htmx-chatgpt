...
* The original package name 'com.example.htmx-chatgpt' is invalid and this project uses 'com.example.htmxchatgpt' instead.
...
```
$ docker run --rm -p 8080:8080 htmx-chatgpt:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/htmx-chatgpt
```
